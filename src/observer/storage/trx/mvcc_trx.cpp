...
RC MvccTrxKit::init()
{
  ...
  fields_ = vector<FieldMeta>{
      ...
      FieldMeta("__trx_xid_begin", AttrType::INTS, 0 /*attr_offset*/, 4 /*attr_len*/, false /*nullable*/, false /*visible*/, -1/*field_id*/),
      FieldMeta("__trx_xid_end", AttrType::INTS, 0 /*attr_offset*/, 4 /*attr_len*/, false /*nullable*/, false /*visible*/, -2/*field_id*/)};
...
RC MvccTrx::update_record(Table *table, Record &Record, const Value &value, const FieldMeta *field)
{
  // TODO
